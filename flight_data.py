...
airlines = ["American Airlines", "Delta Airlines", "Alaska", "Aeromexico",
"Volaris"]
...
transits = ["Airport cab", "Car rental", "Mobility as a service", "Public
Transportation", "Pickup", "Own car"]
...
to_airport = choice(airports)
date = random_date(datetime.datetime(2013, 1, 1),
...
help="Specify the output filename of your csv, defaults to:
flight_passengers.csv", default="flight_passengers.csv")
parser.add_argument("-r", "--rows",
help="Amount of random generated entries for the dataset, defaults to:
100", type=int, default=100)
